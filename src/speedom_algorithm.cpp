...
//     logger.log(INFO, std::format("isFeasible travel distance: {}, current battery: {}, max steps: {}", travel_distance, current_battery, max_steps), FILE_LOC);
...
//     logger.log(INFO, "nextStep", FILE_LOC);
...
//     logger.log(INFO, std::format("current_location: {}, battery_level: {}, dirt_level: {}", current_location.toString(), battery_level, dirt_level), FILE_LOC);
...
//     logger.log(INFO, "getPossibleLocations", FILE_LOC);
...
//     logger.log(INFO, std::format("started BFS from {}", locationTypetoString(start)), FILE_LOC);
...
//     logger.log(INFO, "getDistanceToDoc", FILE_LOC);
...
//        logger.log(INFO, std::format("calcStepToTarget, next location : {}", next.toString()), FILE_LOC);
