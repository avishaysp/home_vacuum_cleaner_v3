...
#define LOG_FATAL(message) logger.log(FATAL, message, FILE_LOC)

#ifdef ENABLE_LOGGING
    #define LOG_INFO(message) logger.log(INFO, message, FILE_LOC)
    #define LOG_WARNING(message) logger.log(WARNING, message, FILE_LOC)
#else
